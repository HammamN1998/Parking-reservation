...
import '../views/home/home_view_reserved.dart';
...
class Routes {
  ...
  static const String homeViewReserved = '/home-view-reserved';
...
class StackedRouter extends RouterBase {
  ...
  final _routes = <RouteDef>[
    ...
    RouteDef(Routes.homeViewReserved, page: HomeViewReserved),
  ...
  final _pagesMap = <Type, StackedRouteFactory>{
    ...
    HomeViewReserved: (data) {
      return MaterialPageRoute<dynamic>(
        builder: (context) => HomeViewReserved(),
        settings: data,
      );
    },
    CategoryView: (data) {
